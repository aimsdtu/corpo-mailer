            ...
            {shouldShowCard(option.id) ? (
              ...
              >
                <motion.div variants={hoverVariants}>
                  <Card className="h-24 w-full border border-gray-200 hover:border-gray-300 transition-colors duration-200 bg-white">
                    <div className="flex items-center h-full px-4 space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-medium text-gray-900 group-hover:text-black transition-colors duration-200 truncate">
                          {option.name}
                        </h3>
                      </div>
                    </div>
